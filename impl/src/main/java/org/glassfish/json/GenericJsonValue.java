...
class GenericJsonValue {
    ...
    GenericJsonValue(MutableJsonStructure mutableStructure) {
        super();
    ...
    GenericJsonValue(JsonValue jsonValue, Ancestor ancestor) {
        super();
        ...
        if (jsonValue.getValueType().equals(JsonValue.ValueType.ARRAY) || jsonValue.getValueType().equals(JsonValue.ValueType.OBJECT)) {
            ...
            this.ancestor = null;
            this.jsonValue = null;
            this.mutableStructure = ((JsonStructure) jsonValue).toMutableJsonStructure();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        GenericJsonValue other = (GenericJsonValue) obj;
        if (jsonValue == null) {
